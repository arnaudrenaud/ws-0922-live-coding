...
export class migration1687526966426 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "wilder" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "isApproved" boolean NOT NULL DEFAULT false, "schoolId" uuid, CONSTRAINT "PK_f6d55a37d2e6430b351b00f3c38" PRIMARY KEY ("id"))`);
